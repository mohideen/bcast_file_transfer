...
module BcastFileTransfer
  ...
  require 'bcast_file_transfer/destination_result'
  ...
  require 'bcast_file_transfer/rsync_transfer'
  require 'bcast_file_transfer/s3_upload_result'
  require 'bcast_file_transfer/s3_transfer_helper'
  require 'bcast_file_transfer/s3_transfer'
